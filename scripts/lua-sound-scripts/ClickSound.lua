...
function script_load(settings)
    -- Register keybind
    hotkey_id = obs.obs_hotkey_register_frontend("clickPlayOnKeybind", "Play Click on keybind", onPress)
    ...
    pause_media_source()
    print("Script loaded: Click sound will play on hotkey press and is paused on load")
...
function script_description()
    return "Play a sound using a hotkey. Ensure a media source named 'Click' is configured with the desired audio file."
end
